...
class TransactionBuilder(object):
    ...
    def send_transaction(self, to, amount, account=None):
        ...
        a corresponding account will be created.
    ...
    def freeze_balance(self, amount, duration, resource, account=None, receiver=None):
        """
        ...
        if not self.tron.isAddress(account) or not self.tron.isAddress(receiver):
    ...
    def create_smart_contract(self, **kwargs):
        ...
        # measured in SUN (1TRX = 1,000,000 SUN)
    ...
    def trigger_smart_contract(
        ...
        Args:
            ...
            fee_limit (int): Maximum TRX consumption, measured in SUN
            call_value (int): Amount of TRX transferred with this transaction,
                                measured in SUN
            parameters (any): Call the virtual machine format of the parameter [1, 2],
                                use the js tool provided by remix,
                                convert the parameter array [1, 2]
    ...
    def update_setting(
        ...
        Args:
            ...
            user_fee_percentage (int): the percentage of resources specified for users
                                        using this contract
    ...
    def update_energy_limit(
        ...
        Args:
            contract_address (str): The address of the contract to be modified
            origin_energy_limit (int): The maximum energy set by the creator
                                        that is created
            owner_address (str): Is the address of the creator
