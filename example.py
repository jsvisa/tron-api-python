...
transaction = tron.trx.get_transaction(
    "757a14cef293c69b1cf9b9d3d19c2e40a330c640b05c6ffa4d54609a9628758c"
)
...
block = list(
    map(lambda x: {"id": x["block_header"]["raw_data"]["number"] or 0}, block_ids)
)
...
event_by_transaction_id = tron.get_event_transaction_id(
    "32d7efe5f70c044bcd831f21f911209a7abf4ed0d5934b2c1b804e108008cd43"
)

logger.debug("Specific event result:")
logger.debug(
    "Transaction: 32d7efe5f70c044bcd831f21f911209a7abf4ed0d5934b2c1b804e108008cd43"
)
